...
4. To print the installed version and exit, run `git aico -V`.
5. The tool will present you with a list of commit message suggestions based on the staged changes.
